...
avarage_connect=$(echo "scale=2; $connect_total / $connect_arr_count" | bc)
avarage_ttfb=$(echo "scale=2; $ttfb_arr_total / $ttfb_arr_count" | bc)
avarage_total=$(echo "scale=2; $total_arr_total / $total_arr_count" | bc)
